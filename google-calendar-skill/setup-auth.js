...
async function main() {
  ...
  try {
    ...
    const envContent = `# Google Calendar API Credentials
...
CALENDAR_CLIENT_SECRET=${clientSecret}
...
`;
    ...
    console.log('');
    console.log('You can now use the Calendar skill:');
    console.log('  node list-calendars.js');
    console.log('  node list-events.js');
